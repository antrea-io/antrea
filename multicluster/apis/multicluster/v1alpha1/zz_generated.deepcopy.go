...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceImportClusterCondition) DeepCopyInto(out *ResourceImportClusterCondition) {
	*out = *in
	in.LastTransitionTime.DeepCopyInto(&out.LastTransitionTime)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceImportClusterCondition.
func (in *ResourceImportClusterCondition) DeepCopy() *ResourceImportClusterCondition {
	if in == nil {
		return nil
	}
	out := new(ResourceImportClusterCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourceImportClusterStatus) DeepCopyInto(out *ResourceImportClusterStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]ResourceImportClusterCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
