...
// Source: controllers/multicluster/commonarea/remote_common_area_manager.go
...
func (mr *MockRemoteCommonAreaManagerMockRecorder) GetNamespace() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNamespace", reflect.TypeOf((*MockRemoteCommonAreaManager)(nil).GetNamespace))
}
