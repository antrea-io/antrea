...
func getClusterServiceCIDR(ctx context.Context, client client.Client) (string, error) {
	...
	err := client.Get(ctx, types.NamespacedName{Name: "kubernetes"}, &svcCIDR)
	if err != nil {
...
func DiscoverClusterServiceCIDR(ctx context.Context, mgrConfig *rest.Config, client client.Client, namespace string) (string, error) {
