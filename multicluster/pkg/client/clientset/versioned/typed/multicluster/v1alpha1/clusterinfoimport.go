...
func (c *clusterInfoImports) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterInfoImport, err error) {
	result = &v1alpha1.ClusterInfoImport{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("clusterinfoimports").
		Name(name).
...
func (c *clusterInfoImports) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterInfoImportList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ClusterInfoImportList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("clusterinfoimports").
...
func (c *clusterInfoImports) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clusterInfoImports) Create(ctx context.Context, clusterInfoImport *v1alpha1.ClusterInfoImport, opts v1.CreateOptions) (result *v1alpha1.ClusterInfoImport, err error) {
	result = &v1alpha1.ClusterInfoImport{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("clusterinfoimports").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(clusterInfoImport).
		Do(ctx).
		Into(result)
	return
}
...
func (c *clusterInfoImports) Update(ctx context.Context, clusterInfoImport *v1alpha1.ClusterInfoImport, opts v1.UpdateOptions) (result *v1alpha1.ClusterInfoImport, err error) {
	result = &v1alpha1.ClusterInfoImport{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterinfoimports").
		Name(clusterInfoImport.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(clusterInfoImport).
		Do(ctx).
		Into(result)
...
func (c *clusterInfoImports) UpdateStatus(ctx context.Context, clusterInfoImport *v1alpha1.ClusterInfoImport, opts v1.UpdateOptions) (result *v1alpha1.ClusterInfoImport, err error) {
	result = &v1alpha1.ClusterInfoImport{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterinfoimports").
...
func (c *clusterInfoImports) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *clusterInfoImports) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *clusterInfoImports) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterInfoImport, err error) {
	result = &v1alpha1.ClusterInfoImport{}
