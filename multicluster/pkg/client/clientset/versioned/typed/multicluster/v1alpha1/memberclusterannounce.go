...
func (c *memberClusterAnnounces) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MemberClusterAnnounce, err error) {
	result = &v1alpha1.MemberClusterAnnounce{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *memberClusterAnnounces) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MemberClusterAnnounceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MemberClusterAnnounceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("memberclusterannounces").
...
func (c *memberClusterAnnounces) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *memberClusterAnnounces) Create(ctx context.Context, memberClusterAnnounce *v1alpha1.MemberClusterAnnounce, opts v1.CreateOptions) (result *v1alpha1.MemberClusterAnnounce, err error) {
	result = &v1alpha1.MemberClusterAnnounce{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("memberclusterannounces").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(memberClusterAnnounce).
		Do(ctx).
		Into(result)
	return
}
...
func (c *memberClusterAnnounces) Update(ctx context.Context, memberClusterAnnounce *v1alpha1.MemberClusterAnnounce, opts v1.UpdateOptions) (result *v1alpha1.MemberClusterAnnounce, err error) {
	result = &v1alpha1.MemberClusterAnnounce{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("memberclusterannounces").
		Name(memberClusterAnnounce.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(memberClusterAnnounce).
		Do(ctx).
		Into(result)
...
func (c *memberClusterAnnounces) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *memberClusterAnnounces) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *memberClusterAnnounces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MemberClusterAnnounce, err error) {
	result = &v1alpha1.MemberClusterAnnounce{}
