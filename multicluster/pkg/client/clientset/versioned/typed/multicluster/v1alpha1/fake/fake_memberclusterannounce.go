...
var memberclusterannouncesResource = v1alpha1.SchemeGroupVersion.WithResource("memberclusterannounces")

var memberclusterannouncesKind = v1alpha1.SchemeGroupVersion.WithKind("MemberClusterAnnounce")
