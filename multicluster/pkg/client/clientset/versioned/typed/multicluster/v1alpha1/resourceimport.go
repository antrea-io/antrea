...
type resourceImports struct {
	*gentype.ClientWithList[*v1alpha1.ResourceImport, *v1alpha1.ResourceImportList]
}
...
func newResourceImports(c *MulticlusterV1alpha1Client, namespace string) *resourceImports {
	return &resourceImports{
		gentype.NewClientWithList[*v1alpha1.ResourceImport, *v1alpha1.ResourceImportList](
			"resourceimports",
			c.RESTClient(),
