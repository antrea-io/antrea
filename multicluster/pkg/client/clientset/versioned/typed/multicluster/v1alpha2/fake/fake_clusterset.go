...
var clustersetsResource = schema.GroupVersionResource{Group: "multicluster.crd.antrea.io", Version: "v1alpha2", Resource: "clustersets"}

var clustersetsKind = schema.GroupVersionKind{Group: "multicluster.crd.antrea.io", Version: "v1alpha2", Kind: "ClusterSet"}
...
func (c *FakeClusterSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.ClusterSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(clustersetsResource, c.ns, name), &v1alpha2.ClusterSet{})
...
func (c *FakeClusterSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.ClusterSetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(clustersetsResource, clustersetsKind, c.ns, opts), &v1alpha2.ClusterSetList{})
...
func (c *FakeClusterSets) Create(ctx context.Context, clusterSet *v1alpha2.ClusterSet, opts v1.CreateOptions) (result *v1alpha2.ClusterSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(clustersetsResource, c.ns, clusterSet), &v1alpha2.ClusterSet{})
...
func (c *FakeClusterSets) Update(ctx context.Context, clusterSet *v1alpha2.ClusterSet, opts v1.UpdateOptions) (result *v1alpha2.ClusterSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(clustersetsResource, c.ns, clusterSet), &v1alpha2.ClusterSet{})
...
func (c *FakeClusterSets) UpdateStatus(ctx context.Context, clusterSet *v1alpha2.ClusterSet, opts v1.UpdateOptions) (*v1alpha2.ClusterSet, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(clustersetsResource, "status", c.ns, clusterSet), &v1alpha2.ClusterSet{})
...
func (c *FakeClusterSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.ClusterSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(clustersetsResource, c.ns, name, pt, data, subresources...), &v1alpha2.ClusterSet{})
