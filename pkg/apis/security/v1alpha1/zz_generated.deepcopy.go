...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkPolicyPortRanges) DeepCopyInto(out *NetworkPolicyPortRanges) {
	*out = *in
	if in.Protocol != nil {
		in, out := &in.Protocol, &out.Protocol
		*out = new(corev1.Protocol)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkPolicyPortRanges.
func (in *NetworkPolicyPortRanges) DeepCopy() *NetworkPolicyPortRanges {
	if in == nil {
		return nil
	}
	out := new(NetworkPolicyPortRanges)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Rule) DeepCopyInto(out *Rule) {
	*out = *in
	...
	if in.PortRanges != nil {
		...
		*out = make([]NetworkPolicyPortRanges, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
