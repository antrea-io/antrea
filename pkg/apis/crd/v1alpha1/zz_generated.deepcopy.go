...
func (in *BGPPolicySpec) DeepCopyInto(out *BGPPolicySpec) {
	*out = *in
	...
	if in.DrainOnTaints != nil {
		in, out := &in.DrainOnTaints, &out.DrainOnTaints
		*out = new(DrainOnTaints)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DrainOnTaints) DeepCopyInto(out *DrainOnTaints) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DrainOnTaints.
func (in *DrainOnTaints) DeepCopy() *DrainOnTaints {
	if in == nil {
		return nil
	}
	out := new(DrainOnTaints)
