...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TCPFlagMatcher) DeepCopyInto(out *TCPFlagMatcher) {
	*out = *in
	if in.Mask != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TCPFlagMatcher.
func (in *TCPFlagMatcher) DeepCopy() *TCPFlagMatcher {
	if in == nil {
		return nil
	}
	out := new(TCPFlagMatcher)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TCPHeader) DeepCopyInto(out *TCPHeader) {
	*out = *in
	...
	if in.Flags != nil {
		...
		*out = make([]TCPFlagMatcher, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
