...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MEDAdvertisement) DeepCopyInto(out *MEDAdvertisement) {
	*out = *in
	if in.BaseValue != nil {
		in, out := &in.BaseValue, &out.BaseValue
		*out = new(int64)
		**out = **in
	}
	if in.Step != nil {
	...
	if in.MaxAdvertisingNodes != nil {
		in, out := &in.MaxAdvertisingNodes, &out.MaxAdvertisingNodes
		*out = new(int32)
		**out = **in
	}
	if in.AllowServiceOverride != nil {
		in, out := &in.AllowServiceOverride, &out.AllowServiceOverride
		*out = new(bool)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MEDAdvertisement.
func (in *MEDAdvertisement) DeepCopy() *MEDAdvertisement {
	if in == nil {
		return nil
	}
	out := new(MEDAdvertisement)
	in.DeepCopyInto(out)
	return out
}
