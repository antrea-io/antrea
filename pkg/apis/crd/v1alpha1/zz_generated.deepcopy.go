...
func (in *OVSBridgeConfig) DeepCopyInto(out *OVSBridgeConfig) {
	*out = *in
	if in.PhysicalInterfaces != nil {
		...
		*out = make([]PhysicalInterfaceConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PhysicalInterfaceConfig) DeepCopyInto(out *PhysicalInterfaceConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PhysicalInterfaceConfig.
func (in *PhysicalInterfaceConfig) DeepCopy() *PhysicalInterfaceConfig {
	if in == nil {
		return nil
	}
	out := new(PhysicalInterfaceConfig)
	in.DeepCopyInto(out)
	return out
}
