...
type ExternalIPPoolSpec struct {
	...
	// AllocateFullCIDR determines whether the network address and broadcast
	// address of each CIDR range in this pool are allocatable.
	AllocateFullCIDR bool `json:"allocateFullCIDR,omitempty"`
}
...
type IPPoolSpec struct {
	...
	// AllocateFullCIDR determines whether the network address (first IP) and broadcast
