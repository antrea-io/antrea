...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IPFamilySubnetInfo) DeepCopyInto(out *IPFamilySubnetInfo) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IPFamilySubnetInfo.
func (in *IPFamilySubnetInfo) DeepCopy() *IPFamilySubnetInfo {
	if in == nil {
		return nil
	}
	out := new(IPFamilySubnetInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NetworkInfo) DeepCopyInto(out *NetworkInfo) {
	*out = *in
	if in.TransportInterfaceIPs != nil {
		in, out := &in.TransportInterfaceIPs, &out.TransportInterfaceIPs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
func (in *SubnetInfo) DeepCopyInto(out *SubnetInfo) {
	*out = *in
	if in.IPFamilySubnets != nil {
		in, out := &in.IPFamilySubnets, &out.IPFamilySubnets
		*out = make([]IPFamilySubnetInfo, len(*in))
		copy(*out, *in)
	}
	return
}
