...
func (in *Advertisements) DeepCopyInto(out *Advertisements) {
	*out = *in
	if in.Services != nil {
		...
		*out = make([]ServiceAdvertisement, len(*in))
		copy(*out, *in)
	}
	if in.Pods != nil {
		in, out := &in.Pods, &out.Pods
		*out = make([]PodAdvertisement, len(*in))
		copy(*out, *in)
	}
	return
}
...
func (in *BGPPeer) DeepCopyInto(out *BGPPeer) {
	*out = *in
	...
	if in.GracefulRestartTime != nil {
		in, out := &in.GracefulRestartTime, &out.GracefulRestartTime
		*out = new(int32)
		**out = **in
	}
	return
