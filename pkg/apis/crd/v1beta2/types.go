...
type EgressSpec struct {
	...
	// Egress. Two addresses, with IPv4 listed before IPv6, represent a dual-stack Egress. When ExternalIPPool is set,
	...
	// IPFamilies specifies the IP families to use when allocating EgressIPs. For a dual-stack Egress, IPv4 must be
	// listed before IPv6. It may be omitted for a dual-stack Egress or when ExternalIPPool contains a single IP family.
...
type EgressStatus struct {
	...
	// EgressIPs are the effective Egress IPs for the selected workloads. For a dual-stack Egress, IPv4 is listed before
	// IPv6. It may be empty when no IP has been allocated or assigned yet.
	EgressIPs  []string          `json:"egressIPs,omitempty"`
