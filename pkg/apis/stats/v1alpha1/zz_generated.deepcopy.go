...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterNetworkPolicyStats) DeepCopyInto(out *ClusterNetworkPolicyStats) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.TrafficStats = in.TrafficStats
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterNetworkPolicyStats.
func (in *ClusterNetworkPolicyStats) DeepCopy() *ClusterNetworkPolicyStats {
	if in == nil {
		return nil
	}
	out := new(ClusterNetworkPolicyStats)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ClusterNetworkPolicyStats) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterNetworkPolicyStatsList) DeepCopyInto(out *ClusterNetworkPolicyStatsList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ClusterNetworkPolicyStats, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterNetworkPolicyStatsList.
func (in *ClusterNetworkPolicyStatsList) DeepCopy() *ClusterNetworkPolicyStatsList {
	if in == nil {
		return nil
	}
	out := new(ClusterNetworkPolicyStatsList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ClusterNetworkPolicyStatsList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeLatencyStats) DeepCopyInto(out *NodeLatencyStats) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	if in.PeerNodeLatencyStats != nil {
		in, out := &in.PeerNodeLatencyStats, &out.PeerNodeLatencyStats
		*out = make([]PeerNodeLatencyStats, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NodeLatencyStats) DeepCopy() *NodeLatencyStats {
	if in == nil {
		return nil
	}
	out := new(NodeLatencyStats)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NodeLatencyStatsList) DeepCopyInto(out *NodeLatencyStatsList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]NodeLatencyStats, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PeerNodeLatencyStats) DeepCopyInto(out *PeerNodeLatencyStats) {
	*out = *in
	if in.TargetIPLatencyStats != nil {
		in, out := &in.TargetIPLatencyStats, &out.TargetIPLatencyStats
		*out = make([]TargetIPLatencyStats, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *TargetIPLatencyStats) DeepCopyInto(out *TargetIPLatencyStats) {
	*out = *in
	in.LastSendTime.DeepCopyInto(&out.LastSendTime)
	in.LastRecvTime.DeepCopyInto(&out.LastRecvTime)
	return
}
