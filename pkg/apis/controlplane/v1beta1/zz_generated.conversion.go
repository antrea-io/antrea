...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*EgressGroupPatch)(nil), (*controlplane.EgressGroupPatch)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_EgressGroupPatch_To_controlplane_EgressGroupPatch(a.(*EgressGroupPatch), b.(*controlplane.EgressGroupPatch), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*controlplane.EgressGroupPatch)(nil), (*EgressGroupPatch)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_controlplane_EgressGroupPatch_To_v1beta1_EgressGroupPatch(a.(*controlplane.EgressGroupPatch), b.(*EgressGroupPatch), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_EgressGroupPatch_To_controlplane_EgressGroupPatch(in *EgressGroupPatch, out *controlplane.EgressGroupPatch, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if in.AddedGroupMembers != nil {
		in, out := &in.AddedGroupMembers, &out.AddedGroupMembers
		*out = make([]controlplane.GroupMember, len(*in))
...
// Convert_v1beta1_EgressGroupPatch_To_controlplane_EgressGroupPatch is an autogenerated conversion function.
func Convert_v1beta1_EgressGroupPatch_To_controlplane_EgressGroupPatch(in *EgressGroupPatch, out *controlplane.EgressGroupPatch, s conversion.Scope) error {
	return autoConvert_v1beta1_EgressGroupPatch_To_controlplane_EgressGroupPatch(in, out, s)
}

func autoConvert_controlplane_EgressGroupPatch_To_v1beta1_EgressGroupPatch(in *controlplane.EgressGroupPatch, out *EgressGroupPatch, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if in.AddedGroupMembers != nil {
		in, out := &in.AddedGroupMembers, &out.AddedGroupMembers
		*out = make([]GroupMember, len(*in))
...
// Convert_controlplane_EgressGroupPatch_To_v1beta1_EgressGroupPatch is an autogenerated conversion function.
func Convert_controlplane_EgressGroupPatch_To_v1beta1_EgressGroupPatch(in *controlplane.EgressGroupPatch, out *EgressGroupPatch, s conversion.Scope) error {
	return autoConvert_controlplane_EgressGroupPatch_To_v1beta1_EgressGroupPatch(in, out, s)
}
