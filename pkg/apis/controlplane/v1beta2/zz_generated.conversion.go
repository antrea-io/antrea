...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*EntityReference)(nil), (*controlplane.EntityReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_EntityReference_To_controlplane_EntityReference(a.(*EntityReference), b.(*controlplane.EntityReference), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*controlplane.EntityReference)(nil), (*EntityReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_controlplane_EntityReference_To_v1beta2_EntityReference(a.(*controlplane.EntityReference), b.(*EntityReference), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_EntityReference_To_controlplane_EntityReference(in *EntityReference, out *controlplane.EntityReference, s conversion.Scope) error {
...
// Convert_v1beta2_EntityReference_To_controlplane_EntityReference is an autogenerated conversion function.
func Convert_v1beta2_EntityReference_To_controlplane_EntityReference(in *EntityReference, out *controlplane.EntityReference, s conversion.Scope) error {
	return autoConvert_v1beta2_EntityReference_To_controlplane_EntityReference(in, out, s)
}

func autoConvert_controlplane_EntityReference_To_v1beta2_EntityReference(in *controlplane.EntityReference, out *EntityReference, s conversion.Scope) error {
	out.Pod = (*PodReference)(unsafe.Pointer(in.Pod))
	out.ExternalEntity = (*ExternalEntityReference)(unsafe.Pointer(in.ExternalEntity))
	return nil
}

// Convert_controlplane_EntityReference_To_v1beta2_EntityReference is an autogenerated conversion function.
func Convert_controlplane_EntityReference_To_v1beta2_EntityReference(in *controlplane.EntityReference, out *EntityReference, s conversion.Scope) error {
	return autoConvert_controlplane_EntityReference_To_v1beta2_EntityReference(in, out, s)
}
