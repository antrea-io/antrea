...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*PortMask)(nil), (*controlplane.PortMask)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_PortMask_To_controlplane_PortMask(a.(*PortMask), b.(*controlplane.PortMask), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*controlplane.PortMask)(nil), (*PortMask)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_controlplane_PortMask_To_v1beta2_PortMask(a.(*controlplane.PortMask), b.(*PortMask), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_PortMask_To_controlplane_PortMask(in *PortMask, out *controlplane.PortMask, s conversion.Scope) error {
	out.Port = (*intstr.IntOrString)(unsafe.Pointer(in.Port))
	out.Mask = (*int32)(unsafe.Pointer(in.Mask))
	return nil
}

// Convert_v1beta2_PortMask_To_controlplane_PortMask is an autogenerated conversion function.
func Convert_v1beta2_PortMask_To_controlplane_PortMask(in *PortMask, out *controlplane.PortMask, s conversion.Scope) error {
	return autoConvert_v1beta2_PortMask_To_controlplane_PortMask(in, out, s)
}

func autoConvert_controlplane_PortMask_To_v1beta2_PortMask(in *controlplane.PortMask, out *PortMask, s conversion.Scope) error {
	out.Port = (*intstr.IntOrString)(unsafe.Pointer(in.Port))
	out.Mask = (*int32)(unsafe.Pointer(in.Mask))
	return nil
}

// Convert_controlplane_PortMask_To_v1beta2_PortMask is an autogenerated conversion function.
func Convert_controlplane_PortMask_To_v1beta2_PortMask(in *controlplane.PortMask, out *PortMask, s conversion.Scope) error {
	return autoConvert_controlplane_PortMask_To_v1beta2_PortMask(in, out, s)
}
...
func autoConvert_v1beta2_Service_To_controlplane_Service(in *Service, out *controlplane.Service, s conversion.Scope) error {
	...
	out.PortMask = (*controlplane.PortMask)(unsafe.Pointer(in.PortMask))
	return nil
}
...
func autoConvert_controlplane_Service_To_v1beta2_Service(in *controlplane.Service, out *Service, s conversion.Scope) error {
	...
	out.PortMask = (*PortMask)(unsafe.Pointer(in.PortMask))
	return nil
}
