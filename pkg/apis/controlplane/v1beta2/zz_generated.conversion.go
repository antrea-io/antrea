...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*GroupPatch)(nil), (*controlplane.GroupPatch)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_GroupPatch_To_controlplane_GroupPatch(a.(*GroupPatch), b.(*controlplane.GroupPatch), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*controlplane.GroupPatch)(nil), (*GroupPatch)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_controlplane_GroupPatch_To_v1beta2_GroupPatch(a.(*controlplane.GroupPatch), b.(*GroupPatch), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_GroupPatch_To_controlplane_GroupPatch(in *GroupPatch, out *controlplane.GroupPatch, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.AddedGroupMembers = *(*[]controlplane.GroupMember)(unsafe.Pointer(&in.AddedGroupMembers))
	out.RemovedGroupMembers = *(*[]controlplane.GroupMember)(unsafe.Pointer(&in.RemovedGroupMembers))
	return nil
...
// Convert_v1beta2_GroupPatch_To_controlplane_GroupPatch is an autogenerated conversion function.
func Convert_v1beta2_GroupPatch_To_controlplane_GroupPatch(in *GroupPatch, out *controlplane.GroupPatch, s conversion.Scope) error {
	return autoConvert_v1beta2_GroupPatch_To_controlplane_GroupPatch(in, out, s)
}

func autoConvert_controlplane_GroupPatch_To_v1beta2_GroupPatch(in *controlplane.GroupPatch, out *GroupPatch, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.AddedGroupMembers = *(*[]GroupMember)(unsafe.Pointer(&in.AddedGroupMembers))
	out.RemovedGroupMembers = *(*[]GroupMember)(unsafe.Pointer(&in.RemovedGroupMembers))
	return nil
...
// Convert_controlplane_GroupPatch_To_v1beta2_GroupPatch is an autogenerated conversion function.
func Convert_controlplane_GroupPatch_To_v1beta2_GroupPatch(in *controlplane.GroupPatch, out *GroupPatch, s conversion.Scope) error {
	return autoConvert_controlplane_GroupPatch_To_v1beta2_GroupPatch(in, out, s)
}
