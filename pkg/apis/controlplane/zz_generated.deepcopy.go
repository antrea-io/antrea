...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PortMask) DeepCopyInto(out *PortMask) {
	*out = *in
	if in.Port != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PortMask.
func (in *PortMask) DeepCopy() *PortMask {
	if in == nil {
		return nil
	}
	out := new(PortMask)
...
func (in *Service) DeepCopyInto(out *Service) {
	*out = *in
	...
	if in.PortMask != nil {
		in, out := &in.PortMask, &out.PortMask
		*out = new(PortMask)
		(*in).DeepCopyInto(*out)
	}
	return
