...
func (pc *podConfigurator) removeInterfaces(containerID string) error {
	...
	if containerConfig.OVSPortConfig == nil {
		klog.InfoS("start to rename VF interface")
		if err := pc.ifConfigurator.renameContainerVFInterfaceName(containerConfig.ContainerNS, containerConfig.IFDev); err != nil {
