...
func (ic *ifConfigurator) moveVFtoContainerNSViaTempNS(vfNetDevice string, containerID string, containerNetNS string, containerIfaceName string, mtu int, result *current.Result) error {
...
func (ic *ifConfigurator) configureContainerSriovLink(
	...
	return ic.moveVFtoContainerNSViaTempNS(vfIFName, containerID, containerNetNS, containerIfaceName, mtu, result)
}
