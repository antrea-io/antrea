...
type Serializer interface {
	...
	Decode(data []byte, into *AnyObjectWithID) error
}
...
func (j *GobSerializer) Decode(data []byte, into *AnyObjectWithID) error {
...
// file already exists.
func (s FileStore) Save(item AnyObjectWithID) error {
...
func (s FileStore) Delete(item AnyObjectWithID) error {
	path := filepath.Join(s.dir, item.UID)
...
// will be removed.
func (s FileStore) ReplaceAll(items []AnyObjectWithID) error {
...
func (s FileStore) LoadAll() ([]AnyObjectWithID, error) {
	var objects []AnyObjectWithID
