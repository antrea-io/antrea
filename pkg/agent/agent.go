...
func (i *Initializer) Initialize() error {
	...
	// Initialize tc qdiscs and filters when traffic mode is noEncap or hybrid to bypass Node host networking for
	// Pod-to-Pod traffic.
	if !i.connectUplinkToBridge &&
		(i.networkConfig.TrafficEncapMode == config.TrafficEncapModeNoEncap ||
