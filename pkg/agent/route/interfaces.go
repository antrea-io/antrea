...
type Interface interface {
	...
	AddNodePortConfigs(nodeIPs []net.IP, svcNodePort uint16, protocol binding.Protocol) error

	// DeleteNodePortConfigs deletes corresponding routing configurations when a NodePort Service is deleted.
	DeleteNodePortConfigs(nodeIPs []net.IP, svcNodePort uint16, protocol binding.Protocol) error
