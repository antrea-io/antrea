...
func (c *Client) syncIPTables(cleanupStaleJumpRules bool) error {
	...
	addFilterRulesToChain(iptablesFilterRulesByChainV4, c.iptablesCache.ipv4[iptablesTagWireguard])
	...
	addFilterRulesToChain(iptablesFilterRulesByChainV6, c.iptablesCache.ipv6[iptablesTagWireguard])
...
func (c *Client) initWireguard() {
	...
	if c.networkConfig.IPv6Enabled {
		c.iptablesCache.ipv6[iptablesTagWireguard].Store(antreaInputChain, antreaInputChainRules)
		c.iptablesCache.ipv6[iptablesTagWireguard].Store(antreaOutputChain, antreaOutputChainRules)
	}
	if c.networkConfig.IPv4Enabled {
		c.iptablesCache.ipv4[iptablesTagWireguard].Store(antreaInputChain, antreaInputChainRules)
		c.iptablesCache.ipv4[iptablesTagWireguard].Store(antreaOutputChain, antreaOutputChainRules)
	}
}
