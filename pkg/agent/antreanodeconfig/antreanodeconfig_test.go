...
func TestSelectMatchingConfigs(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			got := SelectMatchingSecondaryNetworkConfigs(node, tc.configs)
...
func TestSelectMatchingConfigs_TimestampTiebreaker(t *testing.T) {
	...
	got := SelectMatchingSecondaryNetworkConfigs(node, []*crdv1alpha1.AntreaNodeConfig{ancA, ancB})
	require.Len(t, got, 2)
...
func TestApplyConfigs(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			got := ApplySecondaryNetworkConfigs(tc.configs)
...
func TestSelectAndApply(t *testing.T) {
	...
	t.Run("no configs returns nil", func(t *testing.T) {
		assert.Nil(t, SelectAndApplySecondaryNetworkConfigs(node, nil))
	})

	t.Run("non-matching config returns nil", func(t *testing.T) {
		assert.Nil(t, SelectAndApplySecondaryNetworkConfigs(node, []*crdv1alpha1.AntreaNodeConfig{ancOther}))
	})

	t.Run("single matching config applied", func(t *testing.T) {
		got := SelectAndApplySecondaryNetworkConfigs(node, []*crdv1alpha1.AntreaNodeConfig{ancOld})
	...
	t.Run("older matching config takes effect over newer one", func(t *testing.T) {
		got := SelectAndApplySecondaryNetworkConfigs(node, []*crdv1alpha1.AntreaNodeConfig{ancOld, ancNew, ancOther})
		require.NotNil(t, got)
		require.NotNil(t, got.OVSBridge)
		assert.Equal(t, "brA", got.OVSBridge.BridgeName)
