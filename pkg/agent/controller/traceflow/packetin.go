...
// 6. unexpected errors.
func (c *Controller) parsePacketIn(pktIn *ofctrl.PacketIn) (_ *crdv1beta1.Traceflow, _ *crdv1beta1.NodeResult,
	_ *crdv1beta1.Packet, _ *samplingState, shouldSkip bool, _ error) {
