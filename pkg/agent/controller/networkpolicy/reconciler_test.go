...
var (
	...
	ipv6AddressGroup1 = v1beta1.NewGroupMemberSet(newAddressGroupMember("2002:1a23:fb44::1"))
	dualAddressGroup1 = v1beta1.NewGroupMemberSet(newAddressGroupMember("1.1.1.1", "2002:1a23:fb44::1"))
...
func TestReconcilerReconcileIPv6Only(t *testing.T) {
	...
	ipBlock1 := v1beta1.IPBlock{
		CIDR: v1beta1.IPNet{IP: v1beta1.IPAddress(ipNet1.IP), PrefixLength: 112},
	}
	ipBlock2 := v1beta1.IPBlock{
		CIDR: v1beta1.IPNet{IP: v1beta1.IPAddress(ipNet2.IP), PrefixLength: 112},
		Except: []v1beta1.IPNet{
			{IP: v1beta1.IPAddress(ipNet3.IP), PrefixLength: 120},
			{IP: v1beta1.IPAddress(ipNet4.IP), PrefixLength: 124},
		},
	}
	ipBlock3 := v1beta1.IPBlock{
		CIDR: v1beta1.IPNet{IP: v1beta1.IPAddress(ipNet5.IP), PrefixLength: 16},
		Except: []v1beta1.IPNet{
			{IP: v1beta1.IPAddress(diffNet13.IP), PrefixLength: 24},
		},
	}
		...
		},
		{
			...
			&CompletedRule{
				rule: &rule{
					ID:        "egress-rule",
					Direction: v1beta1.DirectionOut,
					To:        v1beta1.NetworkPolicyPeer{IPBlocks: []v1beta1.IPBlock{ipBlock1, ipBlock2, ipBlock3}},
					SourceRef: &np1,
				},
				FromAddresses: nil,
				ToAddresses:   ipv6AddressGroup1,
...
func TestReconcilerReconcileDualStack(t *testing.T) {
	...
	ipBlock4 := v1beta1.IPBlock{
		CIDR: v1beta1.IPNet{IP: v1beta1.IPAddress(ipNet6.IP), PrefixLength: 16},
		Except: []v1beta1.IPNet{
			{IP: v1beta1.IPAddress(ipNet7.IP), PrefixLength: 24},
		},
	}
		...
		},
		{
			...
			&CompletedRule{
				rule: &rule{
					ID:        "ingress-rule",
					Direction: v1beta1.DirectionIn,
					From:      v1beta1.NetworkPolicyPeer{IPBlocks: []v1beta1.IPBlock{ipBlock1, ipBlock2, ipBlock3, ipBlock4}},
					Services:  []v1beta1.Service{serviceTCP80, serviceTCP},
					SourceRef: &np1,
				},
				FromAddresses: dualAddressGroup1,
		...
		},
		{
			...
			&CompletedRule{
				rule: &rule{
					ID:        "egress-rule",
					Direction: v1beta1.DirectionOut,
					To:        v1beta1.NetworkPolicyPeer{IPBlocks: []v1beta1.IPBlock{ipBlock1, ipBlock2, ipBlock3, ipBlock4}},
					SourceRef: &np1,
				},
				FromAddresses: nil,
				ToAddresses:   dualAddressGroup1,
		...
		for i2 := 1; i2 <= 50; i2++ {
			for i3 := 1; i3 <= 10; i3++ {
				pod := &v1beta1.GroupMemberPod{
					IPs: []v1beta1.IPAddress{v1beta1.IPAddress(net.ParseIP(fmt.Sprintf("1.%d.%d.%d", i1, i2, i3)))},
				}
				if withNamedPort {
