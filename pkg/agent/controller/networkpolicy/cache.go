...
type CompletedRule struct {
	*rule
	// Source Endpoints of this rule, can't coexist with ToAddresses.
	FromAddresses v1beta1.GroupMemberSet
	// Destination Endpoints of this rule, can't coexist with FromAddresses.
...
type ruleCache struct {
	...
	// It is a mapping from group name to a set of Endpoints.
