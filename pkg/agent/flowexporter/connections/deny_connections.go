...
func NewDenyConnectionStore(podStore podstore.Interface, proxier proxy.Proxier, o *flowexporter.FlowExporterOptions, protocolFilter []string) *DenyConnectionStore {
