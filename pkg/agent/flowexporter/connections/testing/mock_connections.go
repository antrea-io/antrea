...
//
//	mockgen -build_flags=--tags=linux -copyright_file hack/boilerplate/license_header.raw.txt -destination pkg/agent/flowexporter/connections/testing/mock_connections.go -package testing antrea.io/antrea/pkg/agent/flowexporter/connections ConnTrackDumper,NetFilterConnTrack,DenyStore
//
...
// HasDenyConn mocks base method.
func (m *MockDenyStore) HasDenyConn(key connection.ConnectionKey) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "HasDenyConn", key)
	ret0, _ := ret[0].(bool)
	return ret0
}

// HasDenyConn indicates an expected call of HasDenyConn.
func (mr *MockDenyStoreMockRecorder) HasDenyConn(key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "HasDenyConn", reflect.TypeOf((*MockDenyStore)(nil).HasDenyConn), key)
}
