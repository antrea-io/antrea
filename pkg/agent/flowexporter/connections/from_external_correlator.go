...
// or NodePortLocal) ProxySnatPort is 0; in that case we key by the real client source port so the
// key matches what keyFromAntreaZoneConn will produce for the Antrea-zone counterpart.
