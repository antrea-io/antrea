...
func NewFlowExporter(
	...
	denyConnUpdateChannel := channel.NewSubscribableChannel("Deny Connection", 100)
	...
	poller := connections.NewPoller(connTrackDumper, ctConnUpdateChannel, connections.PollerConfig{
