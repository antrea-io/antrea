...
func Test_client_InstallL7NetworkPolicyFlows(t *testing.T) {
	...
	expectedFlows := []string{
		...
		"cookie=0x1020000000000, table=ConntrackZone, priority=210,ct_state=-rpl+trk,ct_mark=0x90/0x90,ip actions=ct(table=ConntrackState,zone=65520,nat)",
		"cookie=0x1020000000000, table=ConntrackZone, priority=210,ct_state=-rpl+trk,ct_mark=0x80/0x90,ip actions=goto_table:ConntrackState",
