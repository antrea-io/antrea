...
func (f *featurePodConnectivity) flowsToTrace(dataplaneTag uint8,
	...
	// Add controller actions only if not capturing dropped packets only.
	...
	// WireGuard mode uses direct routing for same-subnet traffic, similar to noEncap and hybrid modes.
