...
func (m *MockClient) InstallDualStackSNATMarkFlows(ipv4, ipv6 net.IP, mark uint32) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InstallDualStackSNATMarkFlows", ipv4, ipv6, mark)
	ret0, _ := ret[0].(error)
	return ret0
}

// InstallDualStackSNATMarkFlows indicates an expected call of InstallDualStackSNATMarkFlows.
func (mr *MockClientMockRecorder) InstallDualStackSNATMarkFlows(ipv4, ipv6, mark any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InstallDualStackSNATMarkFlows", reflect.TypeOf((*MockClient)(nil).InstallDualStackSNATMarkFlows), ipv4, ipv6, mark)
}
