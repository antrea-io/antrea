	...
	case config.TrafficEncapModeEncap:
		if !isIPv4 {
			return []string{
				...
				"cookie=0x1010000000000, table=ConntrackState, priority=190,ct_state=-new+trk,ct_mark=0x0/0x10,ipv6 actions=goto_table:EgressSecurityClassifier",
				...
				"cookie=0x1010000000000, table=L3Forwarding, priority=200,ipv6,reg0=0x0/0x200,ipv6_dst=fec0:10:10::/80 actions=set_field:0x30/0xf0->reg0,goto_table:L2ForwardingCalc",
		...
		flows = []string{
			...
			"cookie=0x1010000000000, table=ConntrackState, priority=190,ct_state=-new+trk,ct_mark=0x0/0x10,ip actions=goto_table:EgressSecurityClassifier",
			"cookie=0x1010000000000, table=ConntrackState, priority=0 actions=goto_table:PreRoutingClassifier",
			...
			"cookie=0x1010000000000, table=L3Forwarding, priority=200,ip,reg0=0x0/0x200,nw_dst=10.10.0.0/24 actions=set_field:0x30/0xf0->reg0,goto_table:L2ForwardingCalc",
			"cookie=0x1010000000000, table=L3Forwarding, priority=0 actions=set_field:0x20/0xf0->reg0,goto_table:L2ForwardingCalc",
		...
		if runtime.IsWindowsPlatform() {
			...
			if connectUplinkToBridge {
				flows = append(flows,
					...
					"cookie=0x1010000000000, table=L3Forwarding, priority=200,ip,reg0=0x0/0x200,reg8=0x0/0xfff,nw_dst=10.10.0.0/24 actions=set_field:0x30/0xf0->reg0,goto_table:L2ForwardingCalc", "cookie=0x1010000000000, table=L2ForwardingCalc, priority=200,dl_dst=0a:00:00:00:00:02 actions=set_field:0xfffffffe->reg1,set_field:0x200000/0x600000->reg0,goto_table:ConntrackCommit",
