	...
	for _, tt := range []struct {
		...
		},
		{
			...
			expectedFlows: []string{
				...
				"cookie=0x1020000000000, table=AntreaPolicyIngressRule, priority=201,tun_id=1 actions=conjunction(13,1/2)",
				"cookie=0x1020000000000, table=AntreaPolicyIngressRule, priority=201,tun_id=2 actions=conjunction(13,1/2)",
				"cookie=0x1020000000000, table=AntreaPolicyIngressRule, priority=201,reg1=0x1 actions=conjunction(13,2/2)",
				...
				"cookie=0x1020000000000, table=AntreaPolicyIngressRule, priority=201,reg1=0x2 actions=conjunction(13,2/2)",
