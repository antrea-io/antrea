...
func TestServiceEndpointGroupMaxBuckets(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			sampleEndpoint: proxy.NewBaseEndpointInfo("2001::1", 80, false, true, false, false, nil),
		},
		{
			name:           "IPv4, remote, non-hostNetwork",
			sampleEndpoint: proxy.NewBaseEndpointInfo("192.168.1.1", 80, false, true, false, false, nil),
		},
	}
