...
func getServiceMatchType(protocol *v1beta1.Protocol, ipv4Enabled, ipv6Enabled bool) []*types.MatchKey {
...
func (c *clause) generateServicePortConjMatches(port v1beta1.Service, priority *uint16, ipv4Enabled, ipv6Enabled bool) []*conjunctiveMatch {
