...
func ConfigureSecondaryNetworkInfra(o *SecondaryNetworkOptions) error {
	...
	ofClient1 := openflow.NewClient(o.config.Secondary_OVSBridge1, ovsBridgeMgmtAddr1, false, false, false, false, false, false, false, false, false)
	...
	ofClient2 := openflow.NewClient(o.config.Secondary_OVSBridge2, ovsBridgeMgmtAddr2, false, false, false, false, false, false, false, false, false)
...
func setupDefaultSecondaryTunInterface(br *ovsconfig.OVSBridge, o *SecondaryNetworkOptions) error {
	...
	if !tunPortExist {
		...
		tunnelPortUUID, err := br.CreateTunnelPortExt(defaultSecondaryTunInterfaceName, o.config.Secondary_TunnelType, config.DefaultTunOFPort, false, "", "", "", "", nil, nil)
		if err != nil {
