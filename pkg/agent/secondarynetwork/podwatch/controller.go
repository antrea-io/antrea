...
// the primary and secondary OVS ports in OVSDB are lost. As a result, Pods may
// temporarily appear as "unknown" and later get recreated with new container IDs.
...
// must be checked, and any IPs associated with non-existing container IDs released.
// Otherwise, stale secondary IPs remain in the IPPool and cannot be reused.
