...
// Proxier extends the standard k8sproxy.Provider interface with additional query capabilities defined by ProxyQuerier.
// It serves as an enhanced proxy provider implementation without modifying the original k8sproxy.Provider interface.
type Proxier interface {
	k8sproxy.Provider
	ProxyQuerier
}

// ProxyQuerier the query interface for retrieving information from the Proxy.
