...
type metaProxier struct {
	ipv4Proxier types.Provider
	ipv6Proxier types.Provider
}
...
// on address family.
func NewMetaProxier(ipv4Proxier, ipv6Proxier types.Provider) types.Provider {
	return types.Provider(&metaProxier{
...
func (proxier *metaProxier) GetServiceByIP(serviceStr string) (k8sproxy.ServicePortName, bool) {
