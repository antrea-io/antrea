...
func NewARPResponder(transportInterfaceName string, linkDetector linkdetector.Interface) *arpResponder {
	...
	a := &arpResponder{
		...
		linkEventChan: make(chan struct{}),
	}
	if linkDetector != nil {
		linkDetector.AddEventHandler(a.onLinkUpdate, transportInterfaceName)
	}
...
// This function is not thread-safe.
func NewNDPResponder(transportInterfaceName string, linkDetector linkdetector.Interface) *ndpResponder {
	...
	if linkDetector != nil {
		linkDetector.AddEventHandler(n.onLinkUpdate, transportInterfaceName)
	}
