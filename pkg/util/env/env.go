...
const (
	...
	antreaCloudAKSEnvKey = "ANTREA_CLOUD_AKS"
	antreaCloudEKSEnvKey = "ANTREA_CLOUD_EKS"
	antreaCloudGKEEnvKey = "ANTREA_CLOUD_GKE"

	antreaConfigMapNameEnvKey = "ANTREA_CONFIG_MAP_NAME"
)
...
// Returns true if Antrea is used to enforce NetworkPolicies in an AKS cluster.
func IsCloudAKS() bool {
	return getBoolEnvVar(antreaCloudAKSEnvKey, false)
}

// Returns true if Antrea is used in a GKE cluster.
func IsCloudGKE() bool {
	return getBoolEnvVar(antreaCloudGKEEnvKey, false)
}
