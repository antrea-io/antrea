	...
	tests := []struct {
	...
	}{
		{
			...
			want: []apis.FeatureGateResponse{
				...
				{Component: "agent", Name: "ServiceTrafficDistribution", Status: "Disabled", Version: "ALPHA"},
	...
	tests := []struct {
	...
	}{
		{
			...
			want: []apis.FeatureGateResponse{
				...
				{Component: "agent-windows", Name: "ServiceTrafficDistribution", Status: "Disabled", Version: "ALPHA"},
