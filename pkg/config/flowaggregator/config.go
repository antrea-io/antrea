...
type FlowAggregatorConfig struct {
	...
	// Defaults to 8192.
	RecordBufferSize int32 `yaml:"recordBufferSize,omitempty"`
	// Provide a ClusterID to be added to records. By default this ID is an autogenerated UUID
	// which can be found in the antrea-cluster-identity ConfigMap
...
type FlowStreamServiceConfig struct {
	...
	// against the cluster's client CA bundle.
