...
type FlowCollectorTLSConfig struct {
	// Enable TLS.
	Enable bool `yaml:"enable,omitempty"`
	// Name of the Secret containing the CA certificate used to authenticate the flowCollector.
	// Default root CAs will be used if this field is empty. The certificate must contain the ca.crt key.
