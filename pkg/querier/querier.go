...
type AgentBGPPolicyInfoQuerier interface {
	// GetBGPPolicyInfo returns Name, RouterID, LocalASN, ListenPort, ConfederationIdentier and MemberASNs of effective BGP Policy applied on the Node.
	GetBGPPolicyInfo() (string, string, int32, int32, int32, sets.Set[uint32])
