...
type egressGroupEvent struct {
	...
	// The previous version of the transferred EgressGroup, which will be used in Deleted events.
	// Note that only metadata will be set in Deleted events for efficiency.
	PrevObject *controlplane.EgressGroup
	// The patch object of the message for transferring, which will be used in Modified events.
	PatchObject *controlplane.EgressGroupPatch
