...
func (c *EgressController) syncEgressIPs(egress *egressv1beta1.Egress) ([]net.IP, *egressv1beta1.Egress, error) {
	...
	if forceAutoAllocation {
		// Keep effectiveSpecIPs until after the pool existence check, so stale
