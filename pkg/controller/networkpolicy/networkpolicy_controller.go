...
type NetworkPolicyUsageReporter interface {
	GetNumNamespaces() (int, error)
	GetNumPods() (int, error)
...
func (n *NetworkPolicyController) GetNumNamespaces() (int, error) {
	list, err := n.namespaceLister.List(labels.Everything())
	if err != nil {
...
func (n *NetworkPolicyController) GetNumPods() (int, error) {
	list, err := n.podLister.List(labels.Everything())
	if err != nil {
...
func (n *NetworkPolicyController) GetNumAntreaNetworkPolicies() (int, error) {
	...
	list, err := n.anpLister.List(labels.Everything())
	if err != nil {
...
func (n *NetworkPolicyController) GetNumAntreaClusterNetworkPolicies() (int, error) {
	...
	list, err := n.cnpLister.List(labels.Everything())
	if err != nil {
