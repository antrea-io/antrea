...
type ExternalIPAllocator interface {
	...
	IPPoolIPFamilies(externalIPPool string) ([]corev1.IPFamily, error)
...
func (c *ExternalIPPoolController) IPPoolIPFamilies(pool string) ([]corev1.IPFamily, error) {
