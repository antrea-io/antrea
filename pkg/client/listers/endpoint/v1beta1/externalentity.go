...
type ExternalEntityLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.ExternalEntity, err error)
...
// List lists all ExternalEntities in the indexer.
func (s *externalEntityLister) List(selector labels.Selector) (ret []*v1beta1.ExternalEntity, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.ExternalEntity))
	})
	return ret, err
}
...
type ExternalEntityNamespaceLister interface {
	...
	Get(name string) (*v1beta1.ExternalEntity, error)
...
// List lists all ExternalEntities in the indexer for a given namespace.
func (s externalEntityNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.ExternalEntity, err error) {
...
// Get retrieves the ExternalEntity from the indexer for a given namespace and name.
func (s externalEntityNamespaceLister) Get(name string) (*v1beta1.ExternalEntity, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("externalentity"), name)
	}
	return obj.(*v1beta1.ExternalEntity), nil
}
