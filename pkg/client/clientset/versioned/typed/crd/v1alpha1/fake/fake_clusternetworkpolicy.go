...
var clusternetworkpoliciesResource = v1alpha1.SchemeGroupVersion.WithResource("clusternetworkpolicies")

var clusternetworkpoliciesKind = v1alpha1.SchemeGroupVersion.WithKind("ClusterNetworkPolicy")
