...
func (c *nodeLatencyMonitors) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NodeLatencyMonitor, err error) {
	result = &v1alpha1.NodeLatencyMonitor{}
	err = c.client.Get().
...
func (c *nodeLatencyMonitors) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NodeLatencyMonitorList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.NodeLatencyMonitorList{}
	err = c.client.Get().
		Resource("nodelatencymonitors").
...
func (c *nodeLatencyMonitors) Create(ctx context.Context, nodeLatencyMonitor *v1alpha1.NodeLatencyMonitor, opts v1.CreateOptions) (result *v1alpha1.NodeLatencyMonitor, err error) {
	result = &v1alpha1.NodeLatencyMonitor{}
	err = c.client.Post().
		Resource("nodelatencymonitors").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *nodeLatencyMonitors) Update(ctx context.Context, nodeLatencyMonitor *v1alpha1.NodeLatencyMonitor, opts v1.UpdateOptions) (result *v1alpha1.NodeLatencyMonitor, err error) {
	result = &v1alpha1.NodeLatencyMonitor{}
	err = c.client.Put().
		Resource("nodelatencymonitors").
...
func (c *nodeLatencyMonitors) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NodeLatencyMonitor, err error) {
	result = &v1alpha1.NodeLatencyMonitor{}
