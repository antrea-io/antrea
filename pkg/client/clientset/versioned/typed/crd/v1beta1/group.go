...
func (c *groups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Group, err error) {
	result = &v1beta1.Group{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("groups").
		Name(name).
...
func (c *groups) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.GroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.GroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("groups").
...
func (c *groups) Create(ctx context.Context, group *v1beta1.Group, opts v1.CreateOptions) (result *v1beta1.Group, err error) {
	result = &v1beta1.Group{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("groups").
...
func (c *groups) Update(ctx context.Context, group *v1beta1.Group, opts v1.UpdateOptions) (result *v1beta1.Group, err error) {
	result = &v1beta1.Group{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("groups").
...
func (c *groups) UpdateStatus(ctx context.Context, group *v1beta1.Group, opts v1.UpdateOptions) (result *v1beta1.Group, err error) {
	result = &v1beta1.Group{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("groups").
...
func (c *groups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Group, err error) {
	result = &v1beta1.Group{}
