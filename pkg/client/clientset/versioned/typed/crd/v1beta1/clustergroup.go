...
func (c *clusterGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ClusterGroup, err error) {
	result = &v1beta1.ClusterGroup{}
	err = c.client.Get().
...
func (c *clusterGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ClusterGroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ClusterGroupList{}
	err = c.client.Get().
		Resource("clustergroups").
...
func (c *clusterGroups) Create(ctx context.Context, clusterGroup *v1beta1.ClusterGroup, opts v1.CreateOptions) (result *v1beta1.ClusterGroup, err error) {
	result = &v1beta1.ClusterGroup{}
	err = c.client.Post().
		Resource("clustergroups").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *clusterGroups) Update(ctx context.Context, clusterGroup *v1beta1.ClusterGroup, opts v1.UpdateOptions) (result *v1beta1.ClusterGroup, err error) {
	result = &v1beta1.ClusterGroup{}
	err = c.client.Put().
		Resource("clustergroups").
...
func (c *clusterGroups) UpdateStatus(ctx context.Context, clusterGroup *v1beta1.ClusterGroup, opts v1.UpdateOptions) (result *v1beta1.ClusterGroup, err error) {
	result = &v1beta1.ClusterGroup{}
	err = c.client.Put().
		Resource("clustergroups").
		Name(clusterGroup.Name).
...
func (c *clusterGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ClusterGroup, err error) {
	result = &v1beta1.ClusterGroup{}
