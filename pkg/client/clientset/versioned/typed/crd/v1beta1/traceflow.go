...
func (c *traceflows) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Traceflow, err error) {
	result = &v1beta1.Traceflow{}
	err = c.client.Get().
		Resource("traceflows").
		Name(name).
...
func (c *traceflows) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.TraceflowList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.TraceflowList{}
	err = c.client.Get().
		Resource("traceflows").
...
func (c *traceflows) Create(ctx context.Context, traceflow *v1beta1.Traceflow, opts v1.CreateOptions) (result *v1beta1.Traceflow, err error) {
	result = &v1beta1.Traceflow{}
	err = c.client.Post().
		Resource("traceflows").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *traceflows) Update(ctx context.Context, traceflow *v1beta1.Traceflow, opts v1.UpdateOptions) (result *v1beta1.Traceflow, err error) {
	result = &v1beta1.Traceflow{}
	err = c.client.Put().
		Resource("traceflows").
		Name(traceflow.Name).
...
func (c *traceflows) UpdateStatus(ctx context.Context, traceflow *v1beta1.Traceflow, opts v1.UpdateOptions) (result *v1beta1.Traceflow, err error) {
	result = &v1beta1.Traceflow{}
	err = c.client.Put().
		Resource("traceflows").
		Name(traceflow.Name).
...
func (c *traceflows) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Traceflow, err error) {
	result = &v1beta1.Traceflow{}
