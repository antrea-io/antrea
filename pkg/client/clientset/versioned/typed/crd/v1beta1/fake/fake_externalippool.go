...
var externalippoolsResource = schema.GroupVersionResource{Group: "crd.antrea.io", Version: "v1beta1", Resource: "externalippools"}

var externalippoolsKind = schema.GroupVersionKind{Group: "crd.antrea.io", Version: "v1beta1", Kind: "ExternalIPPool"}
...
func (c *FakeExternalIPPools) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ExternalIPPoolList, err error) {
	...
	list := &v1beta1.ExternalIPPoolList{ListMeta: obj.(*v1beta1.ExternalIPPoolList).ListMeta}
	for _, item := range obj.(*v1beta1.ExternalIPPoolList).Items {
...
func (c *FakeExternalIPPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(externalippoolsResource, name, opts), &v1beta1.ExternalIPPool{})
	return err
}
