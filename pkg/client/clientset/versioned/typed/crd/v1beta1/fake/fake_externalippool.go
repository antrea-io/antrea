...
var externalippoolsResource = v1beta1.SchemeGroupVersion.WithResource("externalippools")

var externalippoolsKind = v1beta1.SchemeGroupVersion.WithKind("ExternalIPPool")
