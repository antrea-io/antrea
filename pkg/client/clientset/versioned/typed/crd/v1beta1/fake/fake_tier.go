...
var tiersResource = schema.GroupVersionResource{Group: "crd.antrea.io", Version: "v1beta1", Resource: "tiers"}

var tiersKind = schema.GroupVersionKind{Group: "crd.antrea.io", Version: "v1beta1", Kind: "Tier"}
...
func (c *FakeTiers) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.TierList, err error) {
	...
	list := &v1beta1.TierList{ListMeta: obj.(*v1beta1.TierList).ListMeta}
	for _, item := range obj.(*v1beta1.TierList).Items {
...
func (c *FakeTiers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(tiersResource, name, opts), &v1beta1.Tier{})
	return err
}
