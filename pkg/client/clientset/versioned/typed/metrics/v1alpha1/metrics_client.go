...
type MetricsV1alpha1Interface interface {
	...
	AntreaClusterNetworkPolicyMetricsesGetter
	AntreaNetworkPolicyMetricsesGetter
	NetworkPolicyMetricsesGetter
}

// MetricsV1alpha1Client is used to interact with features provided by the metrics.antrea.tanzu.vmware.com group.
type MetricsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MetricsV1alpha1Client) AntreaClusterNetworkPolicyMetricses() AntreaClusterNetworkPolicyMetricsInterface {
	return newAntreaClusterNetworkPolicyMetricses(c)
}

func (c *MetricsV1alpha1Client) AntreaNetworkPolicyMetricses(namespace string) AntreaNetworkPolicyMetricsInterface {
	return newAntreaNetworkPolicyMetricses(c, namespace)
}

func (c *MetricsV1alpha1Client) NetworkPolicyMetricses(namespace string) NetworkPolicyMetricsInterface {
	return newNetworkPolicyMetricses(c, namespace)
}
