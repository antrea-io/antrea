...
var addressgroupsResource = schema.GroupVersionResource{Group: "networkpolicy.antrea.io", Version: "v1beta1", Resource: "addressgroups"}

var addressgroupsKind = schema.GroupVersionKind{Group: "networkpolicy.antrea.io", Version: "v1beta1", Kind: "AddressGroup"}
...
func (c *FakeAddressGroups) Get(name string, options v1.GetOptions) (result *v1beta1.AddressGroup, err error) {
	...
	return obj.(*v1beta1.AddressGroup), err
}
...
func (c *FakeAddressGroups) List(opts v1.ListOptions) (result *v1beta1.AddressGroupList, err error) {
	...
	list := &v1beta1.AddressGroupList{ListMeta: obj.(*v1beta1.AddressGroupList).ListMeta}
	for _, item := range obj.(*v1beta1.AddressGroupList).Items {
