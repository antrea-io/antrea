...
type ExternalEntityInterface interface {
	Create(ctx context.Context, externalEntity *v1beta2.ExternalEntity, opts v1.CreateOptions) (*v1beta2.ExternalEntity, error)
	Update(ctx context.Context, externalEntity *v1beta2.ExternalEntity, opts v1.UpdateOptions) (*v1beta2.ExternalEntity, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta2.ExternalEntity, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta2.ExternalEntityList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.ExternalEntity, err error)
...
func newExternalEntities(c *ControlplaneV1beta2Client, namespace string) *externalEntities {
...
func (c *externalEntities) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta2.ExternalEntity, err error) {
	result = &v1beta2.ExternalEntity{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *externalEntities) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.ExternalEntityList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta2.ExternalEntityList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("externalentities").
...
func (c *externalEntities) Create(ctx context.Context, externalEntity *v1beta2.ExternalEntity, opts v1.CreateOptions) (result *v1beta2.ExternalEntity, err error) {
	result = &v1beta2.ExternalEntity{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("externalentities").
...
func (c *externalEntities) Update(ctx context.Context, externalEntity *v1beta2.ExternalEntity, opts v1.UpdateOptions) (result *v1beta2.ExternalEntity, err error) {
	result = &v1beta2.ExternalEntity{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("externalentities").
...
func (c *externalEntities) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.ExternalEntity, err error) {
	result = &v1beta2.ExternalEntity{}
