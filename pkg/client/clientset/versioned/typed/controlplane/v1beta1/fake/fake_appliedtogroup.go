...
var appliedtogroupsResource = schema.GroupVersionResource{Group: "controlplane.antrea.io", Version: "v1beta1", Resource: "appliedtogroups"}

var appliedtogroupsKind = schema.GroupVersionKind{Group: "controlplane.antrea.io", Version: "v1beta1", Kind: "AppliedToGroup"}
...
func (c *FakeAppliedToGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.AppliedToGroupList, err error) {
	obj, err := c.Fake.
