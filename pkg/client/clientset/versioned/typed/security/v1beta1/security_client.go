...
// SecurityV1beta1Client is used to interact with features provided by the security.antrea.tanzu.vmware.com group.
type SecurityV1beta1Client struct {
	restClient rest.Interface
}

func (c *SecurityV1beta1Client) NetworkPolicies(namespace string) NetworkPolicyInterface {
