...
type ClusterNetworkPolicyInterface interface {
	Create(*v1beta1.ClusterNetworkPolicy) (*v1beta1.ClusterNetworkPolicy, error)
	Update(*v1beta1.ClusterNetworkPolicy) (*v1beta1.ClusterNetworkPolicy, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.ClusterNetworkPolicy, error)
	List(opts v1.ListOptions) (*v1beta1.ClusterNetworkPolicyList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ClusterNetworkPolicy, err error)
...
func (c *clusterNetworkPolicies) Get(name string, options v1.GetOptions) (result *v1beta1.ClusterNetworkPolicy, err error) {
	result = &v1beta1.ClusterNetworkPolicy{}
	err = c.client.Get().
...
func (c *clusterNetworkPolicies) List(opts v1.ListOptions) (result *v1beta1.ClusterNetworkPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ClusterNetworkPolicyList{}
	err = c.client.Get().
		Resource("clusternetworkpolicies").
...
func (c *clusterNetworkPolicies) Create(clusterNetworkPolicy *v1beta1.ClusterNetworkPolicy) (result *v1beta1.ClusterNetworkPolicy, err error) {
	result = &v1beta1.ClusterNetworkPolicy{}
	err = c.client.Post().
		Resource("clusternetworkpolicies").
...
func (c *clusterNetworkPolicies) Update(clusterNetworkPolicy *v1beta1.ClusterNetworkPolicy) (result *v1beta1.ClusterNetworkPolicy, err error) {
	result = &v1beta1.ClusterNetworkPolicy{}
	err = c.client.Put().
		Resource("clusternetworkpolicies").
...
func (c *clusterNetworkPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ClusterNetworkPolicy, err error) {
	result = &v1beta1.ClusterNetworkPolicy{}
