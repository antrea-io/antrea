...
type ExternalEntityInterface interface {
	Create(ctx context.Context, externalEntity *v1alpha1.ExternalEntity, opts v1.CreateOptions) (*v1alpha1.ExternalEntity, error)
	Update(ctx context.Context, externalEntity *v1alpha1.ExternalEntity, opts v1.UpdateOptions) (*v1alpha1.ExternalEntity, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.ExternalEntity, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.ExternalEntityList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ExternalEntity, err error)
...
func (c *externalEntities) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ExternalEntity, err error) {
...
func (c *externalEntities) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ExternalEntityList, err error) {
...
func (c *externalEntities) Create(ctx context.Context, externalEntity *v1alpha1.ExternalEntity, opts v1.CreateOptions) (result *v1alpha1.ExternalEntity, err error) {
	result = &v1alpha1.ExternalEntity{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("externalentities").
...
func (c *externalEntities) Update(ctx context.Context, externalEntity *v1alpha1.ExternalEntity, opts v1.UpdateOptions) (result *v1alpha1.ExternalEntity, err error) {
	result = &v1alpha1.ExternalEntity{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("externalentities").
...
func (c *externalEntities) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ExternalEntity, err error) {
	result = &v1alpha1.ExternalEntity{}
