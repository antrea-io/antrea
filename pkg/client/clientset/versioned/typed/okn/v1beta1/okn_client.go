...
import (
	...
	"okn/pkg/client/clientset/versioned/scheme"
...
type ClusterinformationV1beta1Interface interface {
	...
	OKNAgentInfosGetter
	OKNControllerInfosGetter
}

// ClusterinformationV1beta1Client is used to interact with features provided by the clusterinformation.crd.okn.io group.
type ClusterinformationV1beta1Client struct {
	restClient rest.Interface
}

func (c *ClusterinformationV1beta1Client) OKNAgentInfos() OKNAgentInfoInterface {
	return newOKNAgentInfos(c)
}

func (c *ClusterinformationV1beta1Client) OKNControllerInfos() OKNControllerInfoInterface {
	return newOKNControllerInfos(c)
}
