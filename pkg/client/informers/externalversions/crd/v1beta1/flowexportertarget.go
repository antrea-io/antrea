...
type FlowExporterTargetInformer interface {
	...
	Lister() crdv1beta1.FlowExporterTargetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdV1beta1().FlowExporterTargets().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1beta1().FlowExporterTargets().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1beta1().FlowExporterTargets().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1beta1().FlowExporterTargets().Watch(ctx, options)
			},
		},
		&apiscrdv1beta1.FlowExporterTarget{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *flowExporterTargetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiscrdv1beta1.FlowExporterTarget{}, f.defaultInformer)
}

func (f *flowExporterTargetInformer) Lister() crdv1beta1.FlowExporterTargetLister {
	return crdv1beta1.NewFlowExporterTargetLister(f.Informer().GetIndexer())
}
