...
type NetworkPolicyInformer interface {
	...
	Lister() v1alpha2.NetworkPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdV1alpha2().NetworkPolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1alpha2().NetworkPolicies(namespace).Watch(context.TODO(), options)
			},
		},
		&crdv1alpha2.NetworkPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *networkPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdv1alpha2.NetworkPolicy{}, f.defaultInformer)
}

func (f *networkPolicyInformer) Lister() v1alpha2.NetworkPolicyLister {
	return v1alpha2.NewNetworkPolicyLister(f.Informer().GetIndexer())
}
