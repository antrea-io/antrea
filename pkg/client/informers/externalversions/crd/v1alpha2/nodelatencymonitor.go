...
type NodeLatencyMonitorInformer interface {
	...
	Lister() v1alpha2.NodeLatencyMonitorLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdV1alpha2().NodeLatencyMonitors().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1alpha2().NodeLatencyMonitors().Watch(context.TODO(), options)
			},
		},
		&crdv1alpha2.NodeLatencyMonitor{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodeLatencyMonitorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdv1alpha2.NodeLatencyMonitor{}, f.defaultInformer)
}

func (f *nodeLatencyMonitorInformer) Lister() v1alpha2.NodeLatencyMonitorLister {
	return v1alpha2.NewNodeLatencyMonitorLister(f.Informer().GetIndexer())
}
