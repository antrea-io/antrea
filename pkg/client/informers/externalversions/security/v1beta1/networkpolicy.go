	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SecurityV1beta1().NetworkPolicies(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SecurityV1beta1().NetworkPolicies(namespace).Watch(options)
			},
		},
		&securityv1beta1.NetworkPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *networkPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&securityv1beta1.NetworkPolicy{}, f.defaultInformer)
}
