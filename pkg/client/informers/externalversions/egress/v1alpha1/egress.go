...
import (
	...
	v1alpha1 "github.com/vmware-tanzu/antrea/pkg/client/listers/egress/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EgressV1alpha1().Egresses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EgressV1alpha1().Egresses(namespace).Watch(context.TODO(), options)
			},
		},
		&egressv1alpha1.Egress{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *egressInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&egressv1alpha1.Egress{}, f.defaultInformer)
}
