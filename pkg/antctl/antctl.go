			...
			agentEndpoint: &endpoint{
				nonResourceEndpoint: &nonResourceEndpoint{
					...
					params: append([]flagInfo{
						...
						{
							name:            "type",
							usage:           "Get NetworkPolicies with specific type. Type refers to the type of its source NetworkPolicy: K8sNP, ACNP, ANNP or K8sCNP",
							shorthand:       "T",
							supportedValues: []string{"K8sNP", "ACNP", "ANNP", "K8sCNP"},
						},
					}, getSortByFlag()),
					outputType: multiple,
				},
			...
			agentEndpoint: &endpoint{
				nonResourceEndpoint: &nonResourceEndpoint{
					...
					params: []flagInfo{
						...
						{
							name:            "type",
							usage:           "NetworkPolicy type. Valid types are K8sNP, ACNP, ANNP or K8sCNP.",
							supportedValues: []string{"K8sNP", "ACNP", "ANNP", "K8sCNP"},
						},
						{
							name:      "table",
