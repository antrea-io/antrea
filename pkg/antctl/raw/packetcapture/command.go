...
func parseDirection(direction string) (v1alpha1.CaptureDirection, error) {
	...
	case v1alpha1.CaptureDirectionSourceToDestination,
		v1alpha1.CaptureDirectionDestinationToSource,
		v1alpha1.CaptureDirectionBoth:
		return v1alpha1.CaptureDirection(direction), nil
	default:
		return "", fmt.Errorf("invalid direction: %s, must be one of SourceToDestination, DestinationToSource, or Both", direction)
	}
}
