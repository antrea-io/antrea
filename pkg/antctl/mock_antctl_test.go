...
<<<<<<< HEAD
// Source: antrea.io/antrea/v2/pkg/antctl (interfaces: AntctlClient)
//
// Generated by this command:
//
//	mockgen -copyright_file hack/boilerplate/license_header.raw.txt -destination pkg/antctl/mock_antctl_test.go -package antctl antrea.io/antrea/v2/pkg/antctl AntctlClient
=======
