...
func (mr *MockIPFIXExportingProcessMockRecorder) SendSet(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIPFIXAggregationProcessMockRecorder) GetRecords(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
