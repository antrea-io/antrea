...
func TestIPAssigner(t *testing.T) {
	...
	ipAssigner, err := ipassigner.NewIPAssigner(nodeLinkName, dummyDeviceName, nil, true, false)
	...
	newIPAssigner, err := ipassigner.NewIPAssigner(nodeLinkName, dummyDeviceName, nil, true, false)
