...
func testServiceExternalTrafficPolicyLocal(t *testing.T, data *TestData) {
	...
	for idx, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			epsToUpdate := createEndpointSlice(service.Name, service.Namespace, tt.updatedEndpoints)
			epsToUpdate.Name = eps.Name
			epsToUpdate.ResourceVersion = eps.ResourceVersion
