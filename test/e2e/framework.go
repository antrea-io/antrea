...
const (
	...
	ipfixCollectorImage = "antrea/ipfix-collector:latest"
...
func (data *TestData) deployFlowAggregator(
	...
	if ipfixClientCert != nil {
		...
		if _, err := data.clientset.CoreV1().Secrets(flowVisibilityNamespace).Create(context.TODO(), clientCertSecret, metav1.CreateOptions{}); err != nil {
		...
		if ipfixServerCA != nil {
			...
			if _, err := data.clientset.CoreV1().Secrets(data.testNamespace).Create(context.TODO(), serverCASecret, metav1.CreateOptions{}); err != nil {
