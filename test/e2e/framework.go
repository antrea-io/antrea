...
const (
	...
	testAntreaIPAMNamespaceX   string = "antrea-ipam-test-x"
	testAntreaIPAMNamespaceX11 string = "antrea-ipam-test-x11"
	testAntreaIPAMNamespaceX12 string = "antrea-ipam-test-x12"
