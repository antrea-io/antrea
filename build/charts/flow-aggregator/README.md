...
| flowCollector.tls.serverName | string | `""` | If this field is provided, this name will be used to check the server (flowCollector) certificate. By default the provided address will be used. This name will also be included as SNI information. |
