...
| recordBufferSize | int | `8192` | Number of entries in the ring buffer used to distribute flow records to exporters. Each exporter independently consumes from the buffer. Defaults to 8192. |
