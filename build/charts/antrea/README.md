...
| hostNetworkAcceleration.enable | bool | `true` | Enable to accelerate Pod-to-Pod traffic on Node host networking using nftables flowtable when traffic mode is noEncap or hybrid. |
