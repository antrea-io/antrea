...
| hostNetworkAcceleration.enable | bool | `false` | Enable to accelerate Pod-to-Pod traffic on Node host networking when traffic mode is noEncap or hybrid. Currently only Pod-to-Pod traffic is supported, and more cases will be supported in the future. |
