...
![Version: 1.14.0-dev](https://img.shields.io/badge/Version-1.14.0--dev-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: latest](https://img.shields.io/badge/AppVersion-latest-informational?style=flat-square)
...
| packetInRate | int | `500` | packetInRate defines the OVS controller packet rate limits for different features. All features will apply this rate-limit individually on packet-in packets sending to antrea-agent. The number stands for the rate as packets per second(pps) and the burst/queueSize will be automatically set to 2 times of it. When burst/queue is full, new packets will be dropped. |
