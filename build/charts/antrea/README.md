...
| hostNetworkAcceleration.serviceAccelerationPacketThreshold | int | `20` | Minimum number of packets a Service (NodePort/ExternalIP/LoadBalancer) connection must have before it is accelerated. Only connections with more than this many packets are accelerated. Valid range: 0-1000. Impact: 0 accelerates all Service connections regardless of packet count; a higher value (e.g. 20 default, or up to 1000) only accelerates longer-lived or higher-traffic Service connections, reducing overhead for short-lived connections. |
