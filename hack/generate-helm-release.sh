...
sed -i.bak 's=antrea/antrea-agent-ubuntu=antrea/antrea-agent-ubuntu=g' "$ANTREA_CHART/values.yaml"
sed -i.bak 's=antrea/antrea-controller-ubuntu=antrea/antrea-controller-ubuntu=g' "$ANTREA_CHART/values.yaml"
...
sed -i.bak 's=antrea/flow-aggregator=antrea/flow-aggregator=g' "$FLOW_AGGREGATOR_CHART/values.yaml"
