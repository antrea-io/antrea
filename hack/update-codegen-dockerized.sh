...
$GOPATH/bin/client-gen \
  ...
  --input "clusterinformation/v1beta1,networking/v1beta1,crd/v1beta1" \
...
$GOPATH/bin/deepcopy-gen \
  --input-dirs "${ANTREA_PKG}/pkg/apis/clusterinformation/v1beta1,${ANTREA_PKG}/pkg/apis/networking,${ANTREA_PKG}/pkg/apis/networking/v1beta1,${ANTREA_PKG}/pkg/apis/crd/v1beta1" \
