...
git ls-files --modified | xargs -I {} cp ${ANTREA_CODEGEN_PATH}/{} ${ANTREA_SRC_PATH}/{}
git ls-files --others --exclude-standard | xargs -I {} cp ${ANTREA_CODEGEN_PATH}/{} ${ANTREA_SRC_PATH}/{}
