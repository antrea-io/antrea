...
collection cycles.
- **go_gc_heap_allocs_by_size_bytes_total:** Distribution of heap allocations
...
- **go_gc_heap_frees_by_size_bytes_total:** Distribution of freed heap
allocations by approximate size. Note that this does not include tiny objects
as defined by /gc/heap/tiny/allocs:objects, only tiny blocks.
...
- **go_gc_pauses_seconds_total:** Distribution individual GC-related
