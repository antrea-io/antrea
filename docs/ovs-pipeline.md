...
3. table=45, priority=11800,ip,nw_src=40.0.0.6 actions=conjunction(2,1/3)
4. table=45, priority=11800,ip,nw_dst=40.0.0.8 actions=conjunction(2,2/3)
...
{40.0.0.6}, and the destination IP address is in the set {40.0.0.8}, and the
...
3. table=85, priority=11800,ip,nw_src=40.0.0.7 actions=conjunction(1,1/3)
...
{40.0.0.7}, and the destination OF port is in the set {412} (which
correspond to IP addresses {40.0.0.6}), and the destination TCP port
