...
|               | bit 29      |                                 | 0b1            | DSRL2DispatchServiceRegMark     | Packet is destined for a Service in DSR mode which uses the l2 dispatch.                             |
|               |             |                                 | 0b0            | NotDSRL2DispatchServiceRegMark  | Packet is destined for a Service in DSR mode which does not use the l2 dispatch.                     |
|               | bit 30      |                                 | 0b1            | DSRL2DispatchRegMark            | Packet is sent back to the Antrea gateway by the l2 dispatch of DSR.                                 |
|               |             |                                 | 0b0            | NotDSRL2DispatchRegMark         | Packet is not sent back to the Antrea gateway by the l2 dispatch of DSR.                             |
