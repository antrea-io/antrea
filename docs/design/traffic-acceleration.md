...
- Kernel modules (should be built-in or loadable):
  ...
  - `nf_flow_table_inet`, flowtable support for mixed IPv4/IPv6 (inet)
...
```yaml
    hostNetworkAcceleration:
      ...
      # noEncap or hybrid. External-to-Service and Pod-to-external traffic will be supported in the future.
      enable: true
```
