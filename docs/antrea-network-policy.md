...
- **nodeSelector**: The nodes selected by the nodeSelector will be grouped. Note `hostNetwork`
  mode must be on for the pods on the node to be included in the ClusterGroup.
