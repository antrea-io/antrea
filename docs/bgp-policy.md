...
[Section 6.8.4](https://datatracker.ietf.org/doc/html/rfc5880#section-6.8.4) requires. All three are fixed in gobgp
after v4.9.0, and each entry below links to its fix. The notes apply until Antrea moves to a gobgp release that
includes those fixes.

- **The transmit interval is not negotiated.**
  [Section 6.8.7](https://datatracker.ietf.org/doc/html/rfc5880#section-6.8.7) requires a system to slow its
  ...
  Fixed in gobgp by [osrg/gobgp#3653](https://github.com/osrg/gobgp/pull/3653).
- **Transmissions are not jittered.**
  ...
  Fixed in gobgp by [osrg/gobgp#3600](https://github.com/osrg/gobgp/pull/3600).
