...
`antctl` agent command `get bgproutes` prints the advertised BGP routes.
IPv4 routes are advertised to all IPv4 BGP peers. IPv6 routes are advertised to all IPv6 BGP peers.
