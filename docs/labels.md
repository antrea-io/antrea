...
| area/conformance                   | Issues or PRs related to conformance testing | Any |
| area/dependency                    | Issues or PRs related to dependency changes | Any |
| area/e2e-test                      | Issues or PRs related to end-to-end testing. | Any |
...
| do-not-merge/work-in-progress      | Indicates that a PR should not merge because it is a work in progress. | Merge Bot |
| lgtm                               | Idicates thatIndicates that a PR is ready to be merged. | Merge Bot |
