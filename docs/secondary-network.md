...
requiring restarting the agent.
...
oldest one (determined by `creationTimestamp`, with `name` as a tiebreaker) takes effect.
...
The following topology diagram shows the resulted bridges when both AntreaNodeConfig
