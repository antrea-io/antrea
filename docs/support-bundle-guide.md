...
| IP Route All Tables Info    | `agent`, `outside`, `Node`, `ExternalNode`               | Output of `ip route show table all` on Linux (includes per-Egress custom routing tables)                                                                                                                                                                                  |
| IP Rule Info                | `agent`, `outside`, `Node`, `ExternalNode`               | Output of `ip rule` on Linux (policy routing rules managed by Antrea for Egress)                                                                                                                                                                                          |
