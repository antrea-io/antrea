...
Original file https://raw.githubusercontent.com/kubernetes/kubernetes/refs/tags/v1.33.1/pkg/proxy/serviceport.go

Modifies:

- Remove import apiservice "k8s.io/kubernetes/pkg/api/v1/service" and replace its usages with proxyutil.
