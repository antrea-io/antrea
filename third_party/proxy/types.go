...
Original file https://raw.githubusercontent.com/kubernetes/kubernetes/refs/tags/v1.33.1/pkg/proxy/types.go
...
- Add `SyncedOnce() bool` to interface Provider.
- Add `Run(stopCh <-chan struct{})` to interface Provider.
