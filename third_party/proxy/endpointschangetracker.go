...
Original file https://raw.githubusercontent.com/kubernetes/kubernetes/refs/tags/v1.33.1/pkg/proxy/endpointschangetracker.go

Modifies:

- Remove import "k8s.io/kubernetes/pkg/proxy/metrics" and its usages.
- Change type EndpointsMap map[ServicePortName][]Endpoint to EndpointsMap map[ServicePortName]map[string]Endpoint.
