...
Original file https://raw.githubusercontent.com/kubernetes/kubernetes/refs/tags/v1.33.1/pkg/proxy/metaproxier/meta_proxier.go

Modifies:

- Replace import from "k8s.io/kubernetes/pkg/proxy" to "antrea.io/antrea/third_party/proxy".
