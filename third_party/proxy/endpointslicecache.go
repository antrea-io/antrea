...
Original file https://raw.githubusercontent.com/kubernetes/kubernetes/refs/tags/v1.33.1/pkg/proxy/endpointslicecache.go

Modifies:

- Replace import from utilfeature "k8s.io/apiserver/pkg/util/feature" to "antrea.io/antrea/pkg/features".
- Remove import "k8s.io/kubernetes/pkg/features".
- Remove import "sort".
- Change type EndpointsMap map[ServicePortName][]Endpoint to EndpointsMap map[ServicePortName]map[string]Endpoint and
  its usages.
