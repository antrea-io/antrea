...
Original file https://raw.githubusercontent.com/kubernetes/kubernetes/refs/tags/v1.33.1/pkg/proxy/servicechangetracker.go
...
- Add `serviceLabelSelector labels.Selector` to ServiceChangeTracker.
- Add `skipServices sets.Set[string]` to ServiceChangeTracker.
...
func (sct *ServiceChangeTracker) serviceToServiceMap(service *v1.Service) ServicePortMap {
	...
	if proxyutil.ShouldSkipService(service, sct.skipServices, sct.serviceLabelSelector) {
		return nil
	}
