...
VERSION_LDFLAGS = -X antrea.io/antrea/v2/pkg/version.Version=$(VERSION)
VERSION_LDFLAGS += -X antrea.io/antrea/v2/pkg/version.GitSHA=$(GIT_SHA)
VERSION_LDFLAGS += -X antrea.io/antrea/v2/pkg/version.GitTreeState=$(GIT_TREE_STATE)
VERSION_LDFLAGS += -X antrea.io/antrea/v2/pkg/version.ReleaseStatus=$(RELEASE_STATUS)
