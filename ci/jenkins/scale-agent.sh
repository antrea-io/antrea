...
JENKINS_URL="http://jenkins.antrea.io"
...
_usage="Usage: $0 [--workdir <JenkinsPath>] [--setup-only] [--cleanup-only] [--kind] [--jenkins-url <Url>]  [--jenkins-user <User>] [--jenkins-token <Token>] [--gke-project <Project>] [--gke-network <Network>] [--gke-subnet <Subnet>] [--label <Label>] [--max-agents <Number>]
